<template>
  <div class="views__variants">
    <button
      v-on:click="$emit('viewChange', table)"
      class="view__table"
    ...
    >
      ...
      >
        <rect width="6" height="6" fill="#BFBFBF" />
        <rect x="9" width="6" height="6" fill="#BFBFBF" />
        <rect y="9" width="6" height="6" fill="#BFBFBF" />
        <rect x="9" y="9" width="6" height="6" fill="#BFBFBF" />
      </svg>
    </button>
    <button
      v-on:click="$emit('viewChange', grid)"
      class="view__grid "
